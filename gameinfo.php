    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <?php 
                ...
                if($_GET['game'] == 1){
                    echo "<h2>Choice Invaders</h2>
            <h3>This goal of this game is simple. Similar to the retro video game title 'Galaga', your job is to defeat the multiple choice aliens before they get to you! You must use a test set to play this game! Otherwise the game will not run properly!</h3>";
                    
                }elseif($_GET['game'] == 2){
                    echo "<h2>Work in Progress</h2>
            <h3>To be released. You must use a test set to play this game! Otherwise the game will not run properly!</h3>";
                }elseif($_GET['game'] == 3){
                    echo "<h2>Quizzer</h2>
            <h3>Test Yourself with a real multiple choice quiz! Just simply use the test set id, provided by your admin or instructor and take a test! This application requires a test set to start! Otherwise the application will not run properly!</h3>";
...
//            <p>This game is about shooting stuff. You need help.</p>
            ...
            if(isset($_POST['submit'])){
                ...
                if($_GET['game'] == 1){
                    ...
                    redirect("quizzer/index.php?set_id={$_POST['setname']}");
                }
                
                $_SESSION['set_id'] = $_POST['setname'];
     ...
     //header( 'Location: http://www.yoursite.com/new_page.html' ) 
            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                    <input class="form-control btn btn-primary" type="submit" name="submit" value="Play Now!">
                </div>
            </form> 
        </div>
    </div>
